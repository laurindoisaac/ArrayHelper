...
#[derive(Debug)]
pub struct ArrayHelperProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ArrayHelperProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ArrayHelper processing");
    
    let mut processor = ArrayHelperProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ArrayHelperProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ArrayHelperProcessor::new(false);
